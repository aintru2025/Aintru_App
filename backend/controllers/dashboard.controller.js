...
const getDashboardData = async (req, res) => {
  try {
    ...
    for (let i = 5; i >= 0; i--) {
      ...
      const monthInterviews = completedInterviews.filter(
        (interview) =>
    ...
    const dashboardData = {
      ...
      stats: {
        totalInterviews,
        averageScore,
        improvement: 0, // TODO: Calculate real improvement
        hoursPracticed: Math.round(completedInterviews.length * 0.5),
      },
      recentInterviews,
