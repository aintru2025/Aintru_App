...
const GetStartedPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const verifyRes = await fetch('http://localhost:3000/api/auth/verify-credentials', {
        method: 'POST',
      ...
      if (verifyData.isNewUser) {
        ...
        navigate('/login', { 
          state: { 
            message: 'Account already exists. Please login with your email and phone number.' 
          } 
        });
      }
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              We'll verify your credentials before proceeding
            </p>
          </div>
